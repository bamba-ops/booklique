...
class Vue : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val resultatRechercheConteneur: LinearLayout = view.findViewById(R.id.resultat_de_recherche_conteneur)
        val affichageDefilementResultatRecherche: ScrollView = view.findViewById(R.id.affichage_defilement_resultat_de_recherche)
        ...
        entreeRecherche.setOnItemClickListener { _, _, position, _ ->
            ...
            val resultat = obtenirResultatRecherche(choix)
            ...
            if (resultat.isEmpty()) {
                ...
                for (livre in resultat) {
                    ...
                    val itemView = inflater.inflate(R.layout.fragment_article_livre, resultatRechercheConteneur, false)
                    ...
                    val descriptionTextView = itemView.findViewById<TextView>(R.id.livre_description)
    ...
    fun obtenirResultatRecherche(query: String): List<Livre> {
        return listOf(
            Livre("12345", "https://i.imghippo.com/files/YFa6767kO.png", "Story of two friends", "Dans une petite ville entourée de forêts denses et de montagnes, Alex et Jamie partagent une amitié aussi rare que précieuse.", "Avery Davis", "Éditions Horizons Littéraires", "Fiction contemporaine", Date(), 300, 10),
            Livre("67890", "https://i.imghippo.com/files/Al2125oNk.png", "Soul", "À travers un voyage intime et spirituel, Soul explore les profondeurs de l'âme humaine, les questions d'identité et le besoin de se reconnecter avec soi-même.", "Olivia Wilson", "Éditions Éclipse", "Fiction psychologique", Date(), 250, 5)
        ).filter { it.titre.contains(query, ignoreCase = true) }
    }
